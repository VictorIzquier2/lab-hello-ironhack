    ...
    return (
      <div className='App'>
        ...
        <section id='cards-holder'>
          <Card 
            image={this.card1.image}
            title={this.card1.title}
            description={this.card1.description}
          />
          <Card 
            image={this.card2.image}
            title={this.card2.title}
            description={this.card2.description}
          />
          <Card 
            image={this.card3.image}
            title={this.card3.title}
            description={this.card3.description}
          />
          <Card 
            image={this.card4.image}
            title={this.card4.title}
            description={this.card4.description}
          />
        </section>
      </div>
    )
